...
About a year ago I picked up a new hobby: 3d printing. As of October you can add AI-assisted software development to the list. With an AI assitant like Cursor the barrier to getting started with a variety of technologies is much lower, so ideas are much closer to becoming reality than before. And I've got plenty of ideas.

Both of these hobbies are attractive because they bring design, already a fun challenge, right into reality where you can try it, use it, benefit from it, and improve it. Since this time last year I've designed and printed some 31 personal projects and printed innumerable other pre-designed items. And since October I've made 194 commits into my own five repositories, including the revamp of this site, a PHP-powered directory listing tool, a MacOS text service to detect the least common words in a passage, a map of Erin's book reviews, and the beginnings of a tee shirt design showcase. In each of these my long-lapsed web coding experience has been helpful: I have a notion of how a thing could be implemented and I can notice several code smells, but lack familiarity with the most current tech. But a little instruction, a little negotiation, a little correction, and working software is the result.
