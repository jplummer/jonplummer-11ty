...
This is a personal project, offered as-is, without warranty of any kind, and with no guarantee of error-free or continuous operation. I maintain it when I have time to, and may update or discontinue it at any time, though I'll try to give notice. Source is on GitHub under the [MIT License](https://github.com/jplummer/pointer-ar/blob/main/LICENSE) – see the repository for current terms. If this ships through the Apple App Store, the compiled app you download there will also be governed by Apple's standard terms, and shouldn't be redistributed outside Apple's platforms.
