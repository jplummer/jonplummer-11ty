...
![WeMo app lamp rule creation screen](/assets/images/2022/12/ios7_lamprule_iphone5-577x1024.png)
*Creating an automation rule for a lamp, such as scheduling it to turn on at sunset or when motion is detected.*

![WeMo app more options menu](/assets/images/2022/12/ios7_more_iphone5-577x1024.png)
*Additional options menu providing access to settings, device management, and advanced features.*

![WeMo app single-device detail showing power consumption statistics](/assets/images/2022/12/ios7_wemo_iphone5_080613-577x1024.png)
*Single-device detail, showing power consumption statistics.*
...
![WeMo app device setup screen](/assets/images/2022/12/setup.png)
*Device setup and onboarding flow guiding users through connecting new WeMo devices to their home network.*
