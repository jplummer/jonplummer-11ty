...
Fifteen of them worked. The sixteenth was "Keep It Simple."

![The EDIT UI Guidelines Scorecard, sixteen guidelines under four qualities, each with a rating circle and a four-point scale.](/assets/images/2026/09/edit-scorecard.jpg)
*Third column, third from the top, looking exactly as actionable as everything around it.*

Four months on, that line hadn't changed a thing. Everyone agreed with it, but nobody's screens were different. Everyone read it as "take things away," which you should not do when the product needs the things you'd be taking.
...
![A whiteboard headed SIMPLE IS REALLY, with four bullets and five sentences below.](/assets/images/2026/09/simple-is-really.jpg)
*November 2012.*

To make a complex system appear simple, put the complexity below the surface so the person never has to tangle with it. The complexity is real, and since it's necessary, it's staying. The work is to hide it away. The usual means are pre-configuration, intelligent defaults, progressive disclosure, sequential questioning, and automation – and every one of those is a thing you can point at in a design and say whether it's there.
...
So the November board didn't invent anything; it collected. Those lines lived in separate cells, each written about a stage of the experience rather than about simplicity, and pulling them together under "simple," the word we were arguing about, is what turned a disagreement into a list of things to do.
