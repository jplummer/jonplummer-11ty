---
title: How to facilitate a Concept Sprint
...
On scoring: the dimensions are _common_ (does it affect many customers, come up often, matter to the prospects we want?) and _painful_ (expensive, maddening, intractable). These are estimates, not data. If everything clusters high or low on one axis, move the origin; differentiation is almost always there if you look for it. Think of this as a practice run for benefit scoring, which matters more.
...
Ask the group: "How would a customer know that the problems in each of these themes had been solved?" That question puts people in the right frame. Add a reminder that a benefit is a result _not expressed in terms of the solution_. Have people write down benefits, one per sticky, including any they noticed during Immersion.
