...
1. How **common** this problem is among the people we want to sell to (Does it affect many customers? Does it come up often for the affected customers? Is it felt strongly by a set of prospects we are interested in?)
...
1. How **valuable** would this benefit be to customers
