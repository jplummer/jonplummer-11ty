...
*Report setup screen allowing physicians to choose date range and device data to investigate.*
...
*Classic "pick a door" interface for patient selection. (I would not do it this way today.)*
