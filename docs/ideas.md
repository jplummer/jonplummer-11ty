...
- Side project pages — three things that clear the `sides/` bar and have no page there (2026-09-04)
  ...
  - All three are already referenced in [`src/now.md`](../src/now.md) or [`src/about.md`](../src/about.md); link them from there once the pages exist.
